...
CorePackageInitializer_tB06E53DC37B7383143EC96623CD1EB50AE1F2CF6* V_0 = NULL;
	...
	memset((&V_1), 0, sizeof(V_1));
	{
		...
		CorePackageInitializer__ctor_m97F489025B2C46F7E07A944E9AF11E45ABC73A8C(L_0, /*hidden argument*/NULL);
		V_0 = L_0;
...
IL_0009:
	{
		...
		InstallationId__ctor_mD8E8D5B7A72C54F2517D33F9F2C89FA708CC6BF7(L_1, /*hidden argument*/NULL);
		V_0 = L_1;
...
IL_0009:
	{
		...
		ActionScheduler__ctor_m65721521873C0894B75820E4DC934F47E068495D(L_1, /*hidden argument*/NULL);
		V_0 = L_1;
...
IL_002b:
	{
		...
		ExternalUserId__ctor_m100FCF5DA7EFE0D30CE2A9663F0D73510421C555(L_7, /*hidden argument*/NULL);
...
IL_0009:
	{
		...
		Environments__ctor_m907828E3A910416469C90CF39C6D863F6C0B5A6B(L_3, /*hidden argument*/NULL);
...
IL_0009:
	...
	}
	{
		...
		CloudProjectId__ctor_m04C6207EF478495335469EA975A65E82B79BACF7(L_3, /*hidden argument*/NULL);
...
IL_0009:
	{
		...
		UnityThreadUtilsInternal__ctor_m9430BA50989685AA40935124D40A44F29156A3A2(L_1, /*hidden argument*/NULL);
...
IL_00e7:
			{
				...
				UnityProjectNotLinkedException__ctor_mAD5451CE9BDD12E0F183D8E7BA09A469A6C197A1(L_36, ((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteral5FFDD3A1E056986C5C4BF9E6444211A5564EEB6F)), /*hidden argument*/NULL);
...
IL_0074:
		{
			...
			InitializationOptions__ctor_mACA25E99BB9C236F1D65A7BBC84AC194E201FB80(L_20, L_19, /*hidden argument*/NULL);
			NullCheck(L_18);
...
IL_007b:
		{
			...
			Dictionary_2__ctor_mE717AB7B8D8DC0D1E3879C9437CDA2F4FC67D104(L_19, ((int32_t)(((RuntimeArray*)L_18)->max_length)), /*hidden argument*/Dictionary_2__ctor_mE717AB7B8D8DC0D1E3879C9437CDA2F4FC67D104_RuntimeMethod_var);
			...
			ProjectConfiguration__ctor_m0A5FDD512808538C313AFD2B5D56D0FD864A9FE5(L_24, L_22, /*hidden argument*/NULL);
			V_1 = L_24;
			goto IL_00bc;
		}
	}// end try (depth: 1)
