	...
	}
{
		...
		UtcTimeProvider__ctor_m0B5F5EE010F7BDBED40E139D11D931E90D82DFE2(L_0, /*hidden argument*/NULL);
...
PlayerLoopSystem_t8AED6BF1C8A309CAA6FF71AC91DD33BDDFF7CF1F V_0;
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		ScheduledInvocationComparer__ctor_mBC023A46362D70B10A4FB65D8C0BB653C9F5F972(L_1, /*hidden argument*/NULL);
		...
		MinimumBinaryHeap_1__ctor_m9C7E57F3215D01D6C3543B43940790F1AD3BA4F4(L_2, L_1, ((int32_t)10), /*hidden argument*/MinimumBinaryHeap_1__ctor_m9C7E57F3215D01D6C3543B43940790F1AD3BA4F4_RuntimeMethod_var);
		...
		Dictionary_2__ctor_mC2C4F027C0F5DF5863AC1194299269D2907550D2(L_3, /*hidden argument*/Dictionary_2__ctor_mC2C4F027C0F5DF5863AC1194299269D2907550D2_RuntimeMethod_var);
		...
		UpdateFunction__ctor_m0D1D766F22D02176396DA6745A60EA046EE8227B(L_7, __this, (intptr_t)((void*)ActionScheduler_ExecuteExpiredActions_mB683F55950DD543D90A479DF7E68539969F2B48C_RuntimeMethod_var), /*hidden argument*/NULL);
		...
		{// begin try (depth: 1)
			{
				...
				ScheduledInvocation__ctor_mB7D79780A933DBF3A750A1FABB2DAA45852513BD(L_8, /*hidden argument*/NULL);
...
List_1_tFD4080EF47ACD067F2E4AB57C9E2E8E64CA953E3* V_0 = NULL;
	...
	int32_t G_B10_0 = 0;
	{
		...
		List_1__ctor_mDB148E7C9F949120117B65AD14BDD7A5832ABA2F(L_0, /*hidden argument*/List_1__ctor_mDB148E7C9F949120117B65AD14BDD7A5832ABA2F_RuntimeMethod_var);
		V_0 = L_0;
		// lock (m_Lock)
...
IL_00ca:
			...
			{// begin try (depth: 2)
				...
				NullCheck(L_33);
				Action_Invoke_m7126A54DACA72B845424072887B5F3A51FC3808E(L_33, NULL);
				// }
				goto IL_00df;
			}// end try (depth: 2)
			catch(Il2CppExceptionWrapper& e)
