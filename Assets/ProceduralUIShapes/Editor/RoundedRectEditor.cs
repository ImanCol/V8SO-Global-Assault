...
public class RoundedRectEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        roundedRect.material = (Material)EditorGUILayout.ObjectField("Sprite", roundedRect.material, typeof(RawImage), false, GUILayout.Height(EditorGUIUtility.singleLineHeight));
