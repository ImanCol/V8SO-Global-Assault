...
[ExecuteInEditMode]
public class RoundedRect : RawImage
{
    ...
    {
        texture = Resources.Load<Texture>("MaterialRoundedRect");
    ...
    {
        Vector2 pointInRect;
        RectTransformUtility.ScreenPointToLocalPointInRectangle(rectTransform, screenPoint, eventCamera, out pointInRect);
    ...
    private void DefaultValues()
    {
        ...
        material = Resources.Load<Material>("Render-Driver-1");
    }
}