        ...
        switch (state)
        {
            case _CAMERA_TYPE.Default:
                ...
                if (arg1 != 0)
                {
                    ...
                    GameManager.instance.FUN_30CB0(targetVehicle.vCamera, 0);
                    targetVehicle.vCamera = this;
                    LevelManager.instance.defaultCamera.transform.SetParent(transform, false);
                    return 0;
                }
