...
public class GameManager : MonoBehaviour
{
        ...
        public void Execute()
        {
            ...
            do
            {
                ...
                while (true)
                {
                    ...
                    num2++;
                    flag = false;
                    if (num2 == param2 || param1[num13 + 1].y < num11)
                    {
                        flag = true;
                    }
                    if (flag)
            ...
            IL_026f:
                ...
                VigTerrain.FUN_1BE68(num12 >> 10 << 2, num14 >> 10 << 2, num5);
                num5 += 4;
                continue;
            IL_01cc:
                if (num11 == 0 || num9 == 0)
                ...
                if (!flag)
                {
                    num7 = num8 + (param1[num].x - num8) * (num4 - num10) / (param1[num].y - num10);
                    num3 = num9 + (param1[num6].x - num9) * (num4 - num11) / (param1[num6].y - num11);
                    if (num7 < num12)
                    {
                        num12 = num7;
                    }
    ...
    public static short[] SQRT = new short[192]
    {
        4096,
        4127,
        4159,
    ...
    public static short[] UNK4 = new short[192]
    {
        4096,
        4064,
        4033,
    ...
    public static short[] DAT_65C90 = new short[8192]
    {
        0,
        4096,
        6,
    ...
    public static short[] DAT_69C90 = new short[1025]
    {
        0,
        1,
        2,
    ...
    public static uint[,] DAT_637DC = new uint[2, 6]
    {
        {
            0u,
            0u,
    ...
    public static uint[,] DAT_637E0 = new uint[2, 6]
    {
        {
            0u,
            0u,
    ...
    public static Vector3Int[] DAT_63970 = new Vector3Int[6]
    {
    ...
    public static byte[] DAT_639A0 = new byte[16]
    {
        0,
        4,
        1,
    ...
    public static uint[] DAT_639EC = new uint[30]
    {
        4983104u,
        21258u,
        4655744u,
    ...
    public static uint[] DAT_63A6C = new uint[4]
    {
        33554432u,
        67108864u,
        134217728u,
    ...
    public static byte[] DAT_63A7C = new byte[4]
    {
        90,
        89,
        91,
    ...
    public static ushort[] specialLimit = new ushort[18]
    {
        50,
        6,
        3,
    ...
    public static short[] DAT_63F58 = new short[4]
    {
        16,
        17,
        18,
    ...
    public static byte[] DAT_63F60 = new byte[8]
    {
        0,
        0,
        0,
    ...
    public static ushort[] DAT_63F68 = new ushort[5]
    {
        2048,
        0,
        2048,
    ...
    public static ushort[] DAT_63F74 = new ushort[24]
    {
        0,
        0,
        0,
    ...
    public static short[] DAT_63FE4 = new short[60]
    {
        39,
        -1,
        33,
    ...
    public static short[] DAT_6405C = new short[20]
    {
        116,
        123,
        -1,
    ...
    public static short[] DAT_64084 = new short[20]
    {
        53,
        55,
        57,
    ...
    public static int[] DAT_640C8 = new int[4]
    {
        24,
        12,
        8,
    ...
    public static Color32[] DAT_640AC = new Color32[7]
    {
    ...
    public static VehicleData[] vehicleConfigs = new VehicleData[18]
    {
        new VehicleData
        {
            DAT_00 = new short[6]
    ...
    public static Matrix3x3 DAT_718;

    public static byte[] DAT_854;

    public static ushort[] DAT_854_2;

    public static VigTransform defaultTransform;

    public static Vector3Int DAT_9C4;

    public static byte[] DAT_A14;

    public static Vector3Int DAT_A18;

    public static Vector3Int DAT_A24;

    public static Vector3Int DAT_A30;

    public static Vector3Int DAT_A3C;

    public static Vector3Int DAT_A4C;

    public static Vector3Int DAT_A5C;

    public static Vector3Int DAT_A68;

    public static short[] DAT_BC0;

    public static List<Junction> updateJunc;
    ...
    public void SetScreenMode()
    {
        ...
        {
            case 0:
                screenMode = _SCREEN_MODE.Whole;
                spawnsRect.gameObject.SetActive(value: true);
                break;
            case 1:
                screenMode = _SCREEN_MODE.Horizontal;
                spawnsRect.gameObject.SetActive(value: false);
                //DAT_1030[0] = 1;
                //DAT_1030[1] = 0;
                //DAT_1030[2] = 0;
                ...
                break;
            case 2:
                screenMode = _SCREEN_MODE.Vertical;
                break;
            case 3:
                screenMode = _SCREEN_MODE.Unknown;
                break;
        }
    }
    ...
    {
        uint num = (uint)(DAT_DB0 - DAT_F28.position.y);
        Vector3Int param = new Vector3Int(DAT_F28.rotation.V10, DAT_F28.rotation.V11, DAT_F28.rotation.V12);
    ...
    {
        int num = 0;
        AudioSource[] array = voices;
        uint num2 = DAT_E44;
        while ((num2 & 1) != 0 || array[num].isPlaying)
        {
            num++;
    ...
    public bool IsAudioPlaying(int param1, AudioClip param2)
    {
        ...
        if (voices[param1 - 1].clip == param2)
        {
    ...
    public void FUN_1E098(int param1, List<AudioClip> param2, int param3, uint param4, bool param5 = false)
    {
        if (param1 != 0)
        {
            ...
            if (audioClip != null)
            {
                SpuSetVoicePitch(num, sampleRate);
                SpuSetVoiceVolume(num, (short)param4, (short)(param4 >> 16));
                SpuSetVoiceStartAddr(num, audioClip);
    ...
    {
        int dAT_E1C = DAT_E1C;
        uint num = (uint)((ushort)DAT_E1C << 16) >> 31;
        dAT_E1C += (int)num;
        dAT_E1C >>= 1;
        num = (uint)(dAT_E1C << 16);
    ...
    public void FUN_1E28C(int param1, List<AudioClip> param2, int param3)
    {
        ...
        uint num2 = (uint)((int)DAT_E1C + (int)num);
        num2 = (uint)((int)num2 >> 1);
        num2 = (num2 << 16) + num2;
    ...
    public void FUN_1E30C(int source, int sampleRate)
    {
        if (source != 0)
        {
            int num = voices[source - 1].clip.frequency / 11;
    ...
    public void FUN_1E2C8(int source, uint volume)
    {
        if (source != 0)
        {
            int num = (short)volume;
            int num2 = (short)(volume >> 16);
            num &= 0x7FFF;
            if (num > 16383)
            {
                num = (-num & 0x7FFF);
            ...
            voices[source - 1].volume = Mathf.Max(num3, num4);
    ...
    public void FUN_1E1B0(int param1, List<AudioClip> param2, int param3, uint param4, bool param5 = false)
    {
        if (param1 != 0)
        {
            ...
            {
                int num = param1 - 1;
                int sampleRate = (int)(FUN_2AC5C() + 114688) >> 5;
                SpuSetVoicePitch(num, sampleRate);
                SpuSetVoiceVolume(num, (short)param4, (short)(param4 >> 16));
                SpuSetVoiceStartAddr(num, audioClip);
                FUN_1DC0C(param1: true, num & 0x1F, param5);
    ...
    public void FUN_2C0A0(VigObject param1)
    {
        ...
        do
        {
            ...
            if (bufferedBinaryReader == null)
            {
                ...
                {
                    int num = bufferedBinaryReader.ReadInt32((ushort)param1.DAT_1A * 4 + 4);
                    if (num != 0)
                    {
    ...
    public void FUN_2DE84(int param1, Vector3Int param2, Color32 param3)
    {
        ...
        DAT_FA8.SetValue16(num, param3.r << 4);
        ...
        do
        {
            ...
            if ((param1.flags & 4) == 0)
            {
                ...
                if (-1 < num)
                {
                    ...
                    num = FUN_2FE58(param1.child2, param2);
                }
                if (num < -1)
                {
                    return num;
    ...
    public bool FUN_300B8(List<VigTuple> param1, VigObject param2)
    {
        ...
        while (!(vigTuple.vObject == param2));
        if (param1 == DAT_1088)
        {
            DAT_1088_tmp.Add(vigTuple);
        }
        else if (param1 == DAT_1110)
        {
            DAT_1110_tmp.Add(vigTuple);
        }
        else if (param1 == worldObjs)
        {
            worldObjs_tmp.Add(vigTuple);
        }
        else
        {
    ...
    public VigObject FUN_302D4(List<VigTuple> param1, uint param2, int param3)
    {
        for (int i = 0; i < param1.Count; i++)
        {
            ...
            if (vObject.id == param3 && vObject.type == param2)
            {
                return vObject;
            }
            vObject = null;
    ...
    public uint FUN_30334(List<VigTuple> param1, int param2, VigObject param3)
    {
        ...
        {
            VigObject vObject = param1[i].vObject;
            num = (vObject.GetType().IsSubclassOf(typeof(VigObject)) ? vObject.UpdateW(param2, param3) : 0u);
            if (num != 0)
            {
                break;
            }
    ...
    public int FUN_30428(List<VigTuple> param1, uint param2)
    {
        ...
        for (int i = 0; i < param1.Count; i++)
        {
            ...
            if (31 < vigTuple.vObject.id && (flags & param2) != 0 && (flags & 0x8002) == 0)
            {
                num++;
            }
        }
    ...
    public VigObject FUN_30498(List<VigTuple> param1, uint param2, int param3)
    {
        ...
        for (int i = 0; i < param1.Count; i++)
        {
            ...
            if (31 < vigObject.id && (vigObject.flags & param2) != 0 && (vigObject.flags & 0x8002) == 0 && --param3 == -1)
            {
                break;
            }
            vigObject = null;
    ...
    public void FUN_30CB0(VigObject param1, int param2)
    {
        ...
        List<VigTuple> dAT_2 = DAT_1110;
        for (int i = 0; i < dAT_2.Count && (int)dAT_2[i].flag < param2 + dAT_; i++)
        {
        }
    ...
    public Tuple<List<VigTuple>, VigTuple> FUN_310F4(BSP param1, VigObject param2)
    {
        ...
        while (true)
        {
            if (param1.DAT_00 == 0)
            {
                return new Tuple<List<VigTuple>, VigTuple>(param1.LDAT_04, FUN_30134(param1.LDAT_04, param2));
            }
            tuple = FUN_310F4(param1.DAT_08, param2);
            if (tuple.Item2 != null)
            {
                break;
            }
    ...
    public VigObject FUN_31160(BSP param1, int param2, VigObject param3)
    {
        ...
        while (true)
        {
            ...
            vigObject = FUN_31160(param1.DAT_08, param2, param3);
            if (vigObject != null)
            {
                break;
            }
    ...
    public uint FUN_31248(BSP param1, int param2, int param3)
    {
        if (param1.DAT_00 == 0)
        {
            return FUN_30334(param1.LDAT_04, param2, param3);
        }
        if (FUN_31248(param1.DAT_08, param2, param3) == 0 && FUN_31248(param1.DAT_0C, param2, param3) == 0)
        {
            return 0u;
        }
        return 1u;
    ...
    public VigObject FUN_311DC(BSP param1, Type param2)
    {
        ...
        while (true)
        {
            ...
            vigObject = FUN_311DC(param1.DAT_08, param2);
            if (vigObject != null)
            {
                break;
            }
    ...
    public VigObject FUN_31B30(BSP param1, int param2, int param3, Vector2Int param4, Vector2Int param5)
    {
        ...
        switch (param1.DAT_00)
        {
            case 1:
                {
                    ...
                    if (param4.x < dAT_)
                    {
                        VigObject vigObject = FUN_31B30(param1.DAT_08, param2, param3, param4, param5);
                        if (vigObject != null)
                        {
                            return vigObject;
                        }
            ...
            case 0:
                return FUN_31A74(param1.LDAT_04, param2, param3, param4, param5);
            default:
                return null;
            case 3:
                vigObject2 = FUN_31B30(param1.DAT_08, param2, param3, param4, param5);
                if (vigObject2 != null)
                {
                    return vigObject2;
                }
                vigObject2 = FUN_31B30(param1.DAT_0C, param2, param3, param4, param5);
                if (vigObject2 != null)
                {
                    return vigObject2;
                }
    ...
    {
        uint num = FUN_30334(worldObjs, param1, param2);
        if (num == 0)
        {
            return FUN_31248(bspTree, param1, param2);
        }
    ...
    public uint FUN_312DC(BSP param1, _EVENT_CALL param2, int param3)
    {
        ...
        if (param1.DAT_00 == 0)
        {
            num = FUN_303C0(param1.LDAT_04, param2, param3);
        }
        else
        {
            num = FUN_312DC(param1.DAT_08, param2, param3);
            if (num == 0)
            {
                num = FUN_312DC(param1.DAT_0C, param2, param3);
                if (num == 0)
                {
                    num = 0u;
                }
    ...
    public VigObject FUN_31A74(List<VigTuple> param1, int param2, int param3, Vector2Int param4, Vector2Int param5)
    {
        ...
        {
            VigObject vObject = param1[i].vObject;
            if (param2 <= vObject.id && vObject.id <= param3)
            {
    ...
    public void FUN_3150C()
    {
        if (bspTree != null)
        {
            ...
            n.x = -instance.DAT_EDC / 2;
            n.y = 0;
            n.z = instance.DAT_ED8;
            Vector3Int n2 = default(Vector3Int);
            n2.x = instance.DAT_EDC / 2;
            n2.y = 0;
            n2.z = instance.DAT_ED8;
            n = Utilities.VectorNormal(n);
            n2 = Utilities.VectorNormal(n2);
            Utilities.SetRotMatrix(instance.DAT_F28.rotation);
            n = Utilities.FUN_23EA0(n);
            n2 = Utilities.FUN_23EA0(n2);
            int num = n2.x;
            int x = n.x;
            int num2 = num;
            if (x < num)
            ...
            FUN_30DE8(bspTree, instance.DAT_F28.position.x + num3 * 1024, instance.DAT_F28.position.x + num2 * 1024, instance.DAT_F28.position.z + num4 * 1024, instance.DAT_F28.position.z + x * 1024);
        }
    }

    public void FUN_31360(ushort param1)
    {
        List<VigTuple> dAT_10A = DAT_10A8;
        for (int i = 0; i < dAT_10A.Count; i++)
        {
            VigTuple vigTuple = dAT_10A[i];
            if (vigTuple.vObject != null)
            {
                FUN_2FEE8(vigTuple.vObject, param1);
            }
        }
    }
    ...
    public void FUN_313C8(int param1)
    {
        ...
        {
            if (DAT_1088[i].vObject != null && DAT_1088[i].vObject.GetType().IsSubclassOf(typeof(VigObject)))
            {
    ...
    {
        Tuple<List<VigTuple>, VigTuple> tuple = new Tuple<List<VigTuple>, VigTuple>(worldObjs, FUN_30134(worldObjs, param1));
        if (tuple.Item2 == null)
        {
            return FUN_310F4(bspTree, param1);
        }
    ...
    {
        VigObject vigObject = FUN_3027C(worldObjs, param1, null);
        if (vigObject == null)
        {
            vigObject = FUN_31160(bspTree, param1, null);
        }
        return vigObject;
    }
    ...
    {
        VigObject vigObject = FUN_302A8(worldObjs, param1);
        if (vigObject == null)
        {
            vigObject = FUN_311DC(bspTree, param1);
        }
        return vigObject;
    }
    ...
    {
        VigObject vigObject = FUN_30250(DAT_1078, param1);
        if (vigObject == null)
        {
            return null;
        }
        return vigObject.FUN_31DDC();
    }
    ...
    public VigObject FUN_31F1C(Vector3Int param1)
    {
        ...
        VigObject result = null;
        List<VigTuple> dAT_ = DAT_1078;
        for (int i = 0; i < dAT_.Count; i++)
        {
            VigObject vObject = dAT_[i].vObject;
            if ((uint)(vObject.id - 1) < 31u)
            {
    ...
    {
        Placeholder param2 = (Placeholder)FUN_30250(DAT_1078, param1);
        int num = param1 + 1;
        if (param1 < 0)
        {
            num = ~param1;
        }
        return FUN_36C2C(param2, vehicles[num], param1);
    }
    ...
    public void FUN_327CC(VigObject param1)
    {
        ...
        if (!(vigTuple2.vObject.GetType() == typeof(Placeholder)) && (gameMode < _GAME_MODE.Versus2))
        {
    ...
    private void FUN_349A0()
    {
        ...
        //while ((DAT_C6E != 0 || spawns != 30 || DAT_CC4 > 30) && (DAT_C6E != 1 || spawns != 70 || DAT_CC4 > 70) && (spawns != 70 || DAT_CC4 >= 70) && (gameMode <= _GAME_MODE.Versus2 || DiscordController.IsOwner()))
        while ((DAT_C6E != 0 || spawns != 30 || DAT_CC4 > 30) && (DAT_C6E != 1 || spawns != 70 || DAT_CC4 > 70) && (spawns != 70 || DAT_CC4 >= 70) && (gameMode <= _GAME_MODE.Versus2))
        {
    ...
    public void FUN_34B34()
    {
        ...
        {
            int num15 = (DAT_CC4 > 80) ? DAT_CC4 : (DAT_CC4 % 70);
            int num16 = num15 * 2;
            int j = num16;
            if (num16 < 0)
            {
        ...
        if (gameMode == _GAME_MODE.Survival2)
        {
            int num15 = (DAT_CC4 > 80) ? DAT_CC4 : (DAT_CC4 % 70);
            int num16 = num15 * 2;
            int j = num16;
    ...
    {
        int num = (gameMode != _GAME_MODE.Versus2) ? DAT_C6E : 2;
        int num2 = ~num + 3;
        while (true)
        {
            if (num2 == -1)
    ...
    private void FUN_1C158()
    {
        ...
        item.x = DAT_F28.position.x;
        if (DAT_F28.position.x < 0)
        {
            item.x = DAT_F28.position.x + 255;
        }
        item.x >>= 8;
        item.y = DAT_F28.position.y;
        if (DAT_F28.position.y < 0)
        {
            item.y = DAT_F28.position.y + 255;
        }
        item.y >>= 8;
        item.z = DAT_F28.position.z;
        if (DAT_F28.position.z < 0)
        {
            item.z = DAT_F28.position.z + 255;
        }
        item.z >>= 8;
        terrain.UpdatePosition((Vector3)DAT_F28.position / (float)translateFactor);
        DAT_1f800084 = new Vector3Int(-item.x, -item.y, -item.z);
        ...
        int x = DAT_DB4 * (DAT_EDC / 2) * 256 / DAT_ED8;
        uint num = 0u;
        int num2 = 0;
        int y = DAT_DB4 * (DAT_F20 / 2) * 256 / DAT_ED8;
        uint num3 = 0u;
        ...
        do
        {
            if ((uint)(list[x].y + 8) < 12289u)
            {
                list2.Add(new Vector2Int(list[x].x, list[x].z));
                num2++;
            }
            x++;
        }
        ...
        do
        {
            ...
            if (list[index2].y < -8)
            {
                ...
                {
                    y = list[index].x;
                    list2.Add(new Vector2Int(y + (list[index2].x - y) * (-8 - list[index].y) / (list[index2].y - list[index].y), list[index].z + (list[index2].z - list[index].z) * (-8 - list[index].y) / (list[index2].y - list[index].y)));
                    num2++;
                }
            }
            ...
            if (list[index2].y < 12281)
            {
                ...
                {
                    y = list[index].x;
                    list2.Add(new Vector2Int(y + (list[index2].x - y) * (12280 - list[index].y) / (list[index2].y - list[index].y), list[index].z + (list[index2].z - list[index].z) * (12280 - list[index].y) / (list[index2].y - list[index].y)));
                    num2++;
                }
            }
        ...
        do
        {
            ...
            if (y2 < y)
            {
                do
                {
                    ...
                    int num7 = y2 + 1;
                    int index4 = num7;
                    int x2 = list2[index2].x;
                    int y3 = list2[index4].y;
                    int num8 = x2 - num4;
                    int y4 = list2[index2].y;
                    int x3 = list2[index4].x;
                    int num9 = x3 - num4;
                    int num10 = num8 * (y3 - x) - (y4 - x) * num9;
                    if (num10 == 0)
                    {
                        num2--;
                        y--;
                        ...
                        for (num8 = y2 + (flag2 ? 1 : 0); num8 < num2; num8 = num9)
                        {
                            num9 = num8 + 1;
                            num7 = list2[num9].y;
                            list2[num8] = new Vector2Int(list2[num9].x, num7);
                        }
                        y2--;
                    }
                    else if (num10 < 0)
                    {
                        list2[index2] = new Vector2Int(x3, list2[index4].y);
                        list2[index4] = new Vector2Int(x2, y4);
                        if (!flag)
                        {
                            num5 = 1;
                            if (2 < y2)
            ...
            do
            {
                if (1 < x)
                {
                    do
                    {
                        y2 = x - 1;
                        num4 = list2[y2].x;
                        if ((list2[y2].y - list2[x - 2].y) * (list2[index4].x - num4) <= (num4 - list2[x - 2].x) * (list2[index4].y - list2[y2].y))
                        {
                            break;
                        }
                        x = y2;
                ...
                num4 = list2[index4].y;
                list2[x] = new Vector2Int(list2[index4].x, num4);
                x++;
                y++;
                index4++;
            }
        ...
        {
            Coprocessor.accumulator.ir1 = (short)(num2 << 7);
            Coprocessor.ExecuteCC(12, lm: true);
            VigTerrain.DAT_BA4F0[num2] = new Color32(Coprocessor.colorFIFO.r2, Coprocessor.colorFIFO.g2, Coprocessor.colorFIFO.b2, Coprocessor.colorFIFO.cd2);
            DAT_1f800000[num2] = new Color32(terrain.DAT_B9370[num2].r, terrain.DAT_B9370[num2].g, terrain.DAT_B9370[num2].b, 52);
        }
        ...
        nativeArray = new NativeArray<Vector2Int>(list2.Count, Allocator.Persistent);
        for (int i = 0; i < nativeArray.Length; i++)
        {
            nativeArray[i] = list2[i];
        }
    ...
    private int FUN_1E39C(Vector3Int v3)
    {
        ...
        num = ((num != 0) ? ((v3.x << (int)num4) / (num >> (int)(12 - num4))) : 0);
        num2 = (4096 - num) * num3;
        if (num2 < 0)
        {
            num2 += 8191;
