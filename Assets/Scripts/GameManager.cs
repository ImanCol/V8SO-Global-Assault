...
public class GameManager : MonoBehaviour
{
    ...
    private void FUN_349A0()
    {
        ...
        while ((this.difficultyMode != 0 || spawns != 30 || this.EnemyKill > 30) && (this.difficultyMode != 1 || spawns != 70 || this.EnemyKill > 70) && (spawns != 70 || this.EnemyKill >= 70) && (gameMode <= _GAME_MODE.Versus2 || DiscordController.IsOwner()))
        {
    ...
    {
        int num = (gameMode != _GAME_MODE.Versus2) ? this.difficultyMode : 2;
        int num2 = ~num + 3;
        while (true)
        {
            if (num2 == -1)
