...
public class LevelManager : MonoBehaviour
{
    ...
    public Material DAT_DC0; //gp+DC0h
    ...
    {
        FUN_357D4(param1, param2, 0, 0, 0, 0x800, aimpData);
    }
    ...
    public Pickup FUN_4AD78(uint param1)
    {
        ...
        iVar1 = (int)GameManager.instance.FUN_4A970(param1, 0);
        return FUN_4AD24(GameManager.DAT_63FA4[iVar1]);
    }
    ...
    public void FUN_4DF20(Vector3Int param1, ushort param2, short param3)
    {
        ...
        Utilities.FUN_245AC(ref oVar1.vTransform.rotation, local_8);
                ...
                if (uVar3 == 8)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (uVar8 - 0x8800 < 8)
                                    UIManager.instance.FUN_4E414(param3.position, GameManager.DAT_640AC[uVar8 - 0x8800]);
                            }
                        }
                    }
                }
    ...
    public Ballistic FUN_4DD54(VigObject param1, Vector3Int param2, ushort param3)
    {
        ...
        ppcVar1 = xobfList[19].ini.FUN_2C17C(param3, typeof(Ballistic), 8) as Ballistic;
        ppcVar1.type = 7;
        ppcVar1.flags = 0x30;
        ppcVar1.vTransform = GameManager.FUN_2A39C();
    ...
    public void FUN_4DF74(Vector3Int param1, int param2, VigCollider param3)
    {
        ...
        if (param3 != null && param3.reader.ReadUInt16(0) == 1)
        {
            ...
            if (psVar2 != null && psVar2.reader.ReadUInt16(0) == 1)
            {
                ...
                Utilities.FUN_245AC(ref pVar1.vTransform.rotation, local_8);
    ...
    public JUNC_DB FUN_51B74(int param1)
    {
        ...
        if (0 < DAT_1184)
        {
            do
            {
                jVar1 = juncList[iVar2];

                if (jVar1.DAT_12 == param1 && (jVar1.DAT_10 & 0x40) != 0)
                    return jVar1;

                iVar2++;
            } while (iVar2 < DAT_1184);
        }
        ...
        if (0 < DAT_1184)
        {
            do
            {
                ...
                if (piVar9.DAT_11 != 0)
                {
                    do
                    {
                        ppiVar8 = piVar9.DAT_1C[iVar10];

                        if (ppiVar8.DAT_00[0] == piVar9 && (param2 == -1 || (short)ppiVar8.DAT_08 == param2))
                        {
                            iVar7 = ppiVar8.DAT_00[1].DAT_00.x < piVar9.DAT_00.x ? 1 : 0;
                            iVar1 = param1.x - ppiVar8.DAT_00[1 - iVar7].DAT_00.x;
                            iVar5 = ppiVar8.DAT_00[1].DAT_00.z < piVar9.DAT_00.z ? 1 : 0;
                            iVar6 = 0;

                            if (0 < iVar1)
                                iVar6 = iVar1;

                            iVar2 = param1.x - ppiVar8.DAT_00[iVar7].DAT_00.x;
                            iVar1 = 0;

                            if (iVar2 < 0)
                                iVar1 = iVar2;

                            iVar3 = param1.z - ppiVar8.DAT_00[1 - iVar5].DAT_00.z;
                            iVar2 = 0;

                            if (0 < iVar3)
                                iVar2 = iVar3;

                            iVar4 = param1.z - ppiVar8.DAT_00[iVar5].DAT_00.z;
                            iVar3 = 0;
                        ...
                        iVar10++;
                    } while (iVar10 < piVar9.DAT_11);
                }

                iVar13++;
            } while (iVar13 < DAT_1184);
        }
    ...
    private void FUN_3D94(Vehicle param1)
    {
        ...
        if (GameManager.instance.DAT_C6E < 2)
        {
            if (GameManager.instance.DAT_C6E == 0)
                iVar2 = param1.maxHalfHealth << 1;
            else
                iVar2 = param1.maxHalfHealth * 3 >> 1;
