...
public class LevelManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (GameManager.instance.playerObjects[0] == null)
        {
            ...
            {
                //ameManager.instance.playerObjects[0] = GameManager.instance.FUN_3208C(-1, ~DiscordController.GetMemberId());
                //ameManager.instance.playerObjects[0].userId = DiscordController.GetUserId();
