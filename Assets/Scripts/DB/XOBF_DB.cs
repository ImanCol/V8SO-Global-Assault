...
public class XOBF_DB : MonoBehaviour
{
	...
	private void LoadBIN(BinaryReader reader)
	{
				...
				if (0 < tMD.faces)
				{
					...
					using (BinaryWriter binaryWriter = new BinaryWriter(memoryStream, Encoding.Default, leaveOpen: true))
					{
						for (int j = 0; j < tMD.faces; j++)
						{
							...
							case 1:
							case 3:
								binaryWriter.Write(reader.ReadBytes(17));
							...
							case 10:
							{
								...
								binaryWriter.Write(reader.ReadBytes(num18 * 8));
								num16 += num18 * 8;
								break;
							}
							}
							int count = GameManager.DAT_854[(b >> 2) & 0xF] - (int)(reader.BaseStream.Position - num16);
		...
		if (0 < num4)
		{
			...
			{
				reader.BaseStream.Seek(num6 + m * 4, SeekOrigin.Begin);
				int num19 = reader.ReadInt32();
				int count2 = reader.ReadInt32() - num19;
				reader.BaseStream.Seek(num6 + num19, SeekOrigin.Begin);
				cbbList.Add(new VigCollider(reader.ReadBytes(count2)));
			}
		}
		...
		if (0 < num7)
		{
			...
			{
				reader.BaseStream.Seek(num9 + n * 4, SeekOrigin.Begin);
				int num20 = reader.ReadInt32();
				reader.ReadInt32();
				reader.BaseStream.Seek(num9 + num20, SeekOrigin.Begin);
				string path = prefabPath + "/Textures/" + prefabName + "_" + n.ToString().PadLeft(4, '0') + ".bmp";
				string text2 = text + "/Textures/" + prefabName + "_" + n.ToString().PadLeft(4, '0') + ".bmp";
				reader.ReadInt32();
		...
		if (0 < num10)
		{
			...
			vigConfig.xobf = this;
			for (int num21 = 0; num21 < num10; num21++)
			{
